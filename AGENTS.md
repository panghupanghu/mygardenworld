...
- SQLite uses transactional, ordered `PRAGMA user_version` migrations and currently targets schema v14. A database schema change requires a one-way migration and tests; unversioned legacy databases remain rejected.
